...
const Blog = () => {
  return (
    <>
      <aside aria-label="Related articles" className="py-8 lg:py-24 mt-9 bg-gray-50 dark:bg-white">
  <div className="px-4 mx-auto max-w-screen-xl">
      <h2 className="mb-8 text-2xl font-bold text-gray-900 dark:text-black">Related articles</h2>
      <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <article className="max-w-xs">
              ...
              <h2 className="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-black">
                  <a href="#">Feeling Stressed?</a>
              </h2>
              <p className="mb-4 text-gray-500 dark:text-gray-400"> Imagining Nature Can Help You Relax, Scientific Study Says.</p>
